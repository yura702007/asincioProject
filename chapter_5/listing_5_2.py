"""
Команды создания таблиц в схеме базы данных о товарах
"""
CREATE_BRAND_TABLE = """
...
CREATE_SKU_TABLE = """
    CREATE TABLE IF NOT EXISTS sku(
        ...
        FOREIGN KEY (product_size_id) REFERENCES (product_size_id),
        FOREIGN KEY (product_color_id) REFERENCES (product_color_id)
    );
"""
